...
test.describe('Mobile Navigation', () => {
  ...
  test('should navigate with navigation buttons', async ({ page }) => {
    ...
    // Click next button
    const nextButton = page.locator('.navigation-buttons button[aria-label="Go to next month"]');
    ...
    const prevButton = page.locator('.navigation-buttons button[aria-label="Go to previous month"]');
